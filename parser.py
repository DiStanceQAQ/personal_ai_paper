...
def route_parse(
    ...
    from pdf_router import parse_pdf
...
def chunk_parse_document(document: Any) -> Any:
    ...
    from pdf_chunker import chunk_parse_document as _chunk_parse_document
...
def persist_parse_result(
    ...
    from pdf_persistence import persist_parse_result as _persist_parse_result
